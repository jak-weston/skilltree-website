      ...
      >
        <div className="w-full container mx-auto flex justify-between items-center px-4 ">
          ...
          <div className="hidden md:flex">
            <Button className="glass-button text-white hover:text-white font-bold shadow-lg hover:shadow-blue-500/25">
              Get Started
            </Button>
          </div>
              ...
              <ClickAwayListener onClickAway={() => setIsOpen(false)}>
                <div className="p-4 space-y-4">
                  ...
                  <div className="pt-4 border-t border-white/10">
                    <Button className="w-full glass-button text-white hover:text-white font-bold shadow-lg hover:shadow-blue-500/25">
                      Get Started
                    </Button>
                  </div>
                </div>
